    ...
    $().SPServices({
        ...
        completefunc: function (xData, Status) {				
            $(xData.responseXML).SPFilterNode("z:row").each(function() {	
                ...
                i = i + 1
                //$("#PrintingContent").append(output);
                //query attachment item		
                $().SPServices({
                    ...
                    completefunc: function(xData, Status) {
                        ...
                        $(xData.responseXML).find("Attachments > Attachment").each(function(i, el) 
                        {
                           ...
                           FP = AttID+"/"+ FileName;
                            ...
                            output += "<li class='PrintItems' id="+ListId+"  style='list-style: none ;' ><input type='checkbox' id='checkbox" +
                             AttID 	+"' name='checkbox' class='CheckBoxes' style='Display:inline;' data-docname='"+ FileName+"' data-fp='"+FilePath+"' data-itemid='"+AttID +"' /><p id='IsPrinted'>"+ Title + " - " + Vessel + "</p></li><br />";
